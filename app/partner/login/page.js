    ...
    <div className="min-h-screen bg-[#0B1F33] flex items-center justify-center px-6 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        <div className="bg-white rounded-2xl shadow-sm p-8">
          <h1 className="text-[#0B1F33] font-black text-2xl mb-1">Partner Login</h1>
          <p className="text-[#0B1F33]/50 text-sm mb-6">Manage your center, listings and bookings.</p>
          ...
          <p className="text-center text-sm text-[#0B1F33]/50 mt-5">
            New partner?{" "}
            <button onClick={() => router.push("/partner/register")} className="text-[#83C52B] font-semibold">
